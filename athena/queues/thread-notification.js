        ...
        attachments: [
          {
            ...
            author_link: `http://ec2-18-224-212-70.us-east-2.compute.amazonaws.com/users/${author.username}`,
            ...
            title_link: `http://ec2-18-224-212-70.us-east-2.compute.amazonaws.com/thread/${incomingThread.id}`,
            text: truncateString(plainTextBody, 140),
            footer: 'Spectrum',
            footer_icon:
              'http://ec2-18-224-212-70.us-east-2.compute.amazonaws.com/img/apple-icon-57x57-precomposed.png',
            ...
            actions: [
              {
                ...
                url: `http://ec2-18-224-212-70.us-east-2.compute.amazonaws.com/thread/${incomingThread.id}`,
              },
              {
                type: 'button',
                text: `Message ${author.name}`,
                url: `http://ec2-18-224-212-70.us-east-2.compute.amazonaws.com/users/${author.username}`,
              },
            ],
          },
        ],

<div align="center">
  ...
  [![Spectrum](./public/img/media.png)](http://ec2-18-224-212-70.us-east-2.compute.amazonaws.com)

  ### Simple, powerful online communities.

</div>

This is the main monorepo codebase of [Spectrum](http://ec2-18-224-212-70.us-east-2.compute.amazonaws.com). Every single line of code that's not packaged into a reusable library is in this repository.
...
Spectrum has been in full-time development since March 2017 and is [part of GitHub since November 2018](http://ec2-18-224-212-70.us-east-2.compute.amazonaws.com/spectrum/general/spectrum-is-joining-github~1d3eb8ee-4c99-46c0-8daf-ca35a96be6ce). See our current priorities and what we are working on in the [main project board](https://github.com/withspectrum/spectrum/projects/23).

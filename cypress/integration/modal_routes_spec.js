...
const communityBeforeUrlIsValid = () =>
  cy.url().should('eq', 'http://18.224.212.70:3000/spectrum?tab=posts');
const channelBeforeUrlIsValid = () =>
  cy.url().should('eq', 'http://18.224.212.70:3000/spectrum/general?tab=posts');
...
describe('thread modal route', () => {
  ...
  it('handles esc key', () => {
    ...
    cy.url(
      'eq',
      'http://18.224.212.70:3000/spectrum/private/yet-another-thread~thread-6'
    );
  ...
  it('handles channel feed', () => {
    ...
    cy.url(
      'eq',
      'http://18.224.212.70:3000/spectrum/spectrum/general/yet-another-thread~thread-9'
    );
